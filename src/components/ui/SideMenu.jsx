  ...
  return (
    <div onClick={() => closeMenu(false)} className='z-99 fixed top-0 left-0 w-full bg-gray-400/40 h-screen'>
      <div onClick={(e) => e.stopPropagation()} className='w-[80%] bg-white h-full flex flex-col'>
        <div className='p-3 flex justify-between pb-2 border-b border-gray-300  font-semibold'>
          <Link to={'/'} className="flex items-center gap-5">
            <div className="flex items-center gap-1">
              ...
              <h1 className="block lg:hidden font-bold lg:text-lg text-sm text-gold">Ella Nuts and Oil</h1>
            </div>
          </Link>
        ...
        {/* our categories */}
        <div className='pb-3 border border-gray-300'>
        ...
        <div className='flex justify-center items-center gap-7 p-3 text-gold'>
          <Facebook size={22} />
          <Instagram size={22} />
          <FaTiktok size={22} />
          <FaWhatsapp size={22} />
