...
export const HeroDisplayCard = ({hero}) => {
  ...
  return (
    <div className={`${hero?.bg} px-5 lg:px-5 h-full w-full flex justify-center items-center`}>
      <div className='w-300 mx-auto'>
        <div className='w-full'>
          <h1 className='text-3xl lg:text-5xl lg:max-w-4xl tracking-wide lg:leading-14  mb-2 font-semibold'>{hero?.title}</h1>
          <p className='text-2xl lg:text-3xl '>{hero?.desc}</p>
        </div>
